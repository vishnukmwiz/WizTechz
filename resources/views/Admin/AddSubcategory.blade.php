...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 m-2">
      ...
      <form class="row contact_form" action="/addsubcategory" method="post" enctype="multipart/form-data" novalidate="novalidate">
        {{csrf_field()}}
        <div class="row">
          <div class="col-7">
            <table class="table table-borderless table-warning">
              ...
              <tr>
                ...
                <td><input type="text" class="form-control"  name="desc" value="" ></td>
              </tr>
              <tr>
