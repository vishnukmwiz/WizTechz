...
<div class="container ">
    <div class=" row m-2 ps-5 pe-5 bg-white">
        ...
        <div class="col-12 col-sm-12 col-md-8 col-lg-6 d-flex flex-column justify-content-center align-items-center">
            <img class="img-fluid p-auto m-auto" src="../assets/images/CartEmpty.png" alt="">
        </div>
        <div class="col-12 col-sm-12 col-md-4 col-lg-3 d-flex flex-column justify-content-center align-items-center">
            <label class="m-2" for="">Your cart is empty.Add items..</label>
            <a href="ProductList?cat=0&sub=0&brand=0" class="btn btn-warning">Continue Shopping</a>
        </div>
    </div>
</div>
</section>
