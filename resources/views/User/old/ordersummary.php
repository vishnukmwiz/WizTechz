                ...
                <div class="row">
                  <table class="table table-bordered col-md-4" id="dataTable"  cellspacing="0">
                    ...
                    <div class=" card mb-4 col-md-4">
                      ...
                      <div class="card-body">
                        <label><strong><?php echo $cus[0]['customer_fname']." ".$cus[0]['customer_lname'] ?></strong></label> <br>
                        <label>Date of Birth:<strong><?php echo $cus[0]['customer_dob'] ?></strong></label><br>
                        <label>Address:<address><strong><?php echo $cus[0]['customer_house'] ?><br>
                        <?php echo $cus[0]['customer_street'] ?><br>
                        <?php echo $cus[0]['customer_city'] ?><br>
                        <?php echo $cus[0]['customer_district'] ?><br>
                          <?php echo $cus[0]['customer_pin'] ?><br></strong></address></label> 
                          
                          <label>Email: <strong><?php echo $cus[0]['customer_email'] ?></strong></label><br>
                          <label>Phone: <strong><?php echo $cus[0]['customer_phno'] ?></strong></label><br>
                              <a  class="btn btn-primary " href="ordersummary2.php">
                           
                              <span class=" font-weight-bold">Edit address</span></h6>
                    ...
                    <div class=" card mb-4 col-md-4">
                      ...
                      <div class="card-body">
                        ...
                        <form action="" method="post">
                          <input type="radio" name="paymode" checked="" value="cashondelivery">Cash on Delivery &nbsp;
                          <input type="radio" name="paymode" value="card">Credit/Debit Card
                          <input class="btn btn-primary "type="submit" name="submitorder" value="Proceed to payment">
                        </form>
                        <?php include("services/cart.php"); ?>
                      </div>
                    </div>
                  </div>
                <?php } ?>
