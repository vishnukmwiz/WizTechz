...
<div style="padding-top: 1rem;padding-left: 1rem;" id="logo">
    ...
    <nav class="topbar navbar-expand navbar-dark bg-dark mb-4 static-top shadow">
        ...
        <div class="container-fluid">
          <div style="background: white; padding: 2rem;border-radius: 25px;" class="mb-4 col footer-info"><center><h1>ABOUT US</h1></center>
          ...
          <div style="background: white; padding: 2rem;border-radius: 25px;" class="mb-4 col footer-contact">
            <h4>Contact Us</h4>
            <p>
